...
import com.example.koreanrestaurantapp.ui_user.home.HomeFragment;
...
//
   private BottomNavigationView btnavView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnavView = findViewById(R.id.nav_view_menu);
        btnavView.setSelectedItemId(R.id.navbt_menu);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case(R.id.navbt_table):
                        Intent intentTable= new Intent(AdminActivity.this,AdTable.class);
                        startActivity(intentTable);
                        return true;
                    case(R.id.navbt_report):
                        Intent intentReport= new Intent(AdminActivity.this,AdReport.class);
                        startActivity(intentReport);
                        return true;
                    case(R.id.navbt_setting):
                        Intent intentSetting= new Intent(AdminActivity.this,AdSetting.class);
    ...
    private void showUpdateDialog(String key,Category item) {
        ...
        imagecategory=update_cate.findViewById(R.id.imagecategory);
